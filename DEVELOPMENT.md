...
```bash
git remote add encore encore://smart-calculator-hub-v9pi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/smart-calculator-hub-v9pi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/smart-calculator-hub-v9pi/settings/integrations/github)
